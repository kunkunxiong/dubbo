...
function myFunction(pageCount, pageNum, totalCount, pageSize, num, pageContent){
	$("#"+pageContent).append("<font><font size='5'>一共</font><font color='#2ECCFA' id='pageCount' size='6'>"+pageCount+"</font><font size='5'>页</font></font>"); 
	$("#"+pageContent).append("<font>&nbsp;<font size='5'>当前第</font><font color='#2ECCFA' size='6'>"+pageNum+"</font><font size='5'>页</font></font>");
	$("#"+pageContent).append("<font>&nbsp;<font size='5'>一共</font><font id='totalCount' color='#2ECCFA' size='6'>"+totalCount+"</font><font size='5'>条记录</font></font>");
	$("#"+pageContent).append("&nbsp;<font size='5'>每页</font><select id='pageBar' style='border-radius:5px;height:30px;' onChange=changePageSize("+totalCount+","+pageNum+") ><option value='2'>2</option><option value='3'>3</option><option value='5'>5</option><option value='10'>10</option></select><font size='5'>条数据</font>");
